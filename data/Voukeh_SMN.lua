...
function init_gear_sets()
    ...
    legs="Evoker's Spats", feet="Herald's Gaiters", lring="Evoker's Ring"  }
    ...
    sets.perp = {
    main="Chatoyant Staff" , lring="Evoker's Ring", body="Penance Robe", head="Penance Hat", legs="Evoker's Spats" }

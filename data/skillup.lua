...
function get_sets()
    ...
    sets.brd = {}
    sets.brd.wind = {
        range="Horn +1"--put your wind instrument here
    }
    sets.brd.string = {
    ...
    healingcount = 1
    enhancespells = {"Refresh","Baraera","Baraero","Barblizzara","Barblizzard","Barfira","Barfire","Barstone","Barstonra","Barthunder","Barthundra","Barwater","Barwatera"}
    enhancecount = 1
